...
This repository contains the 3216 Robophins code used in the 2022-2023 FTC Powerplay season

The following text is the ReadMe from the forked FTC-Robot-Controller which contains lots information on how to download the project and clone it for yourself. If you have trouble setting up th project on your device you can ask a Robophins member at club or contact me.
...
The readme.md file located in the [/TeamCode/src/main/java/org/firstinspires/ftc/teamcode](TeamCode/src/main/res/firstinspires/ftc/teamcode) folder contains an explanation of the sample naming convention, and instructions on how to copy them to your own project space.
